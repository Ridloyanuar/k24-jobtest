      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
              <form method="post" action="{{ url('admin/member/added') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-first-name" class="form-control" placeholder="No Handphone" name="no_hp">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name">Tanggal Lahir</label>
                        <input type="date" id="input-first-name" class="form-control" placeholder="Tanggal Lahir" name="tanggal_lahir">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-first-name" class="form-control" placeholder="No KTP" name="no_ktp">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      ...
                      <label class="form-control-label" for="input-first-name">Foto Diri</label>
                        <input type="file" id="input-first-name" class="form-control" placeholder="Foto Diri" name="foto_diri">
                      </div>
                    </div>
                  </div>
