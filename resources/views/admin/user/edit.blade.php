                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-first-name" class="form-control" placeholder="Name" name="name" value="{{$admin->name}}">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name">Email</label>
                        <input type="email" id="input-first-name" class="form-control" placeholder="Email" name="email" value="{{$admin->email}}">
                      </div>
                    </div>
                  </div>
